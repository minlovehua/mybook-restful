...
MarkBox.prototype = {
    ...
    createMarkBox: function(w, h) {
        ...
        if (flag) {
            ...
            var html = "<div style='line-height:40px;height:40px;padding-left:10px;width:" + w + ";background:#00CED1;'><span>" + this.title + "</span><span id='closeId' style='float:right;color:red;line-height:40px;margin-right:5px;cursor:pointer'>关闭</span></div>";
